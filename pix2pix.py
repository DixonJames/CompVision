...
# ==============================================================================
"""Pix2pix.
this code is part of the following Tensorflow repository: [https://github.com/tensorflow/examples/blob/master/tensorflow_examples/models/pix2pix/pix2pix.py]
at was accessed on 06/04/2023.

modification and private use are amongst the permissions by the apache licence
Therefore it is free to be used on this coursework
"""
